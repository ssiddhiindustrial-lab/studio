      ...
      <section className="bg-primary py-24 text-white">
        <div className="container px-4 text-center">
          <div className="max-w-3xl mx-auto space-y-6">
            <h1 className="text-4xl md:text-6xl font-bold font-headline">Industrial Expertise</h1>
            <p className="text-xl text-white/70">World-class construction services tailored for the most demanding industrial requirements.</p>
          </div>
        </div>
      </section>
            ...
            {services.map((service) => (
              <div key={service.id} className="bg-white rounded-2xl border shadow-sm flex flex-col hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
                ...
                <div className="p-8 border-t bg-secondary/30 rounded-b-2xl">
                  <Button asChild className="w-full bg-primary hover:bg-accent hover:text-accent-foreground group/btn">
      ...
      <section className="py-24 bg-secondary">
        <div className="container px-4">
          <div className="max-w-4xl mx-auto text-center space-y-12">
            <div className="space-y-4">
              <h2 className="text-accent font-bold uppercase tracking-wider">The Siddhi Approach</h2>
              <h3 className="text-3xl md:text-5xl font-bold font-headline text-primary">Uncompromising Quality Management</h3>
              <p className="text-lg text-muted-foreground">Every project follows our rigorous 4-step execution framework: Precise Planning, High-Grade Material Sourcing, Skilled Engineering, and Continuous Safety Audits.</p>
            </div>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
              {['Planning', 'Sourcing', 'Building', 'HSE Audit'].map((step, i) => (
                <div key={i} className="bg-white p-6 rounded-xl shadow-sm border border-accent/20 flex flex-col items-center">
