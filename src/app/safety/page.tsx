...
export default function SafetyPage() {
  const safetyProtocols = [
    ...
    { title: "Zero Compromise", desc: "A strict 'Stop Work' authority granted to any employee who observes an unsafe condition.", icon: Activity }
  ]
        ...
        <div className="container px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {safetyProtocols.map((item, i) => (
              <div key={i} className="bg-white p-8 rounded-2xl border shadow-sm hover:border-accent transition-colors group">
