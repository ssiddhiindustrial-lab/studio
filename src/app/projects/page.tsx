  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] w-full space-y-4">
        ...
        <p className="text-muted-foreground animate-pulse font-medium">Loading Portfolio...</p>
      </div>
    )
  }
        ...
        <div className="container mx-auto px-4 flex flex-col items-center">
          {projects.length === 0 ? (
            <div className="text-center py-20 space-y-4">
              ...
              <p className="text-muted-foreground">We are updating our portfolio. Please check back soon.</p>
            </div>
          ) : (
