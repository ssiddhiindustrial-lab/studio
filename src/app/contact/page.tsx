        ...
        <div className="container px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            ...
            <div className="space-y-12">
              <div className="bg-white p-10 rounded-3xl shadow-xl border relative overflow-hidden">
              ...
              <div className="bg-secondary/50 p-10 rounded-3xl border border-accent/20 space-y-8">
                <div className="space-y-2">
                ...
                {aiResult && (
                  <div className="bg-white p-6 rounded-2xl border border-accent/30 animate-in fade-in slide-in-from-bottom-4 space-y-4">
            ...
            <div className="space-y-12">
              <div className="space-y-8">
                ...
                <div className="space-y-8">
                  <div className="flex gap-6 items-start group">
                    <div className="bg-primary text-white p-4 rounded-2xl group-hover:bg-accent group-hover:text-accent-foreground transition-colors">
              ...
              {/* Map Placeholder */}
              <div className="relative h-[400px] w-full rounded-3xl overflow-hidden shadow-lg grayscale hover:grayscale-0 transition-all duration-700">
                <iframe 
